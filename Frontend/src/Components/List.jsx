...
const Add = () => {
  ...
  return (<div className='mx-auto h-[85%] sm:h-[80%] font-quicksand'>
    <div className='w-[70vw] sm:w-[52vw] h-[100%] bg-[#f9f9f9] mx-auto rounded-[10px] px-[10px] sm:px-[20px] py-[10px] text-black'>
      <div className=''>
        <div className='text-black font-bold pl-[1px] sm:pl-[4px] text-[16px] sm:text-1xl'>Add a Todo</div>
        <div className='flex gap-1 sm:gap-2  items-center'>
          <input value={Todo} onKeyDown={(e) => { handlekey(e) }} onChange={handlechange} className='bg-[#063766] w-[90%]  h-[30px] rounded-[20px] px-[2px] sm:px-[8px] focus:outline-1 focus:border-[2px] focus:border-[black] text-[white]' type="text" placeholder='Write something' />
      ...
      <div className='w-[40vw] mx-auto h-[1px] bg-black my-[15px]'></div>
      <div className='mx-[4px] h-[70%]'>
        ...
        <div className='  h-[90%]'>
          <ul className='list-none mt-1 overflow-x-auto h-[100%] scrollbar-hide'>
            {Todos.map(item => {
              return (showfinished || !item.completed) && < li key={item.uuid} className='flex justify-between  h-[auto] hover:bg-[#ff7b92] w-[100%] my-[5px]' >
